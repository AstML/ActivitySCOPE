...
\multicolumn{13}{l}{\textbf{Cometary orbits (multiple oppositions when flagged)} \textnormal{\footnotesize (sorted by $S_{\rm EV}$, ascending)}}\\
\midrule

\objectcell{2010~RH$_{69}$$^{\ast}$$^{\ddag}$} &
3.90 & 4.27 & 0.087 & 11.92 & 2.97 & 13.9 & 3 & 18.6 & 0.999992 & 11.6 & 0.00000 &
\notecell{Comet identified independently by this work} \\

\objectcell{362P/(457175) 2008~GO$_{98}$$^{\ast}$} &
2.86 & 3.97 & 0.279 & 15.56 & 2.93 & 12.9 & 7 & 24.5 & 0.999992 & 14.0 & 0.00002 &
\notecell{\citet{2017CBET.4411....1L}} \\

\objectcell{282P/(323137) 2003~BM$_{80}$$^{\ast}$} &
3.44 & 4.23 & 0.188 & 5.81 & 2.99 & 13.6 & 7 & 22.3 & 0.999992 & 12.0 & 0.00010 &
\notecell{\citet{2022ApJ...937L...2C,chandlerActiveAsteroidsCitizen2024}} \\

\objectcell{2017~QN$_{84}$$^{\ast}$} &
2.47 & 3.77 & 0.343 & 12.07 & 2.94 & 15.0 & 4 & 12.6 & 0.999990 & 5.0 & 0.00309 &
\notecell{\citet{chandlerActiveAsteroidsCitizen2024,2025epsc.conf.1661F}} \\

\objectcell{2008~VK$_{110}$$^{\Vert}$} &
4.44 & 7.17 & 0.381 & 7.39 & 2.88 & 14.1 & 3 & 6.8 & 0.967416 & -0.4 & 0.06993 &
\notecell{Identified by \activityscope{}; Possible morphologic confirmation; Brightness varies across oppositions} \\

\midrule
\multicolumn{13}{l}{\textbf{Cometary orbits (single opposition when flagged)} \textnormal{\footnotesize (sorted by $P(N_{\rm opp}\ge4)$, descending)}}\\
\midrule

\objectcell{2001~BV$_{70}$} &
2.06 & 3.59 & 0.426 & 4.33 & 2.95 & 15.1 & 1 & 16.2 & 0.999992 & 11.1 & 0.00000 &
\notecell{High-confidence candidate; archival confirmation unavailable} \\

\objectcell{P/2025~UX$_{109}$ (Ye)$^{\ast}$} &
2.57 & 3.81 & 0.325 & 3.18 & 2.98 & 15.0 & 1 & 16.8 & 0.999990 & 12.7 & 0.00000 &
...
3.94 & 4.38 & 0.100 & 5.22 & 3.01 & 14.6 & 1 & 17.1 & 0.999989 & 12.2 & 0.00000 &
\notecell{\citet{oldroydCometaryActivityDiscovered2023}} \\

\objectcell{2018~BJ$_{11}$$^{\ast}$} &
3.25 & 4.20 & 0.226 & 3.43 & 2.99 & 15.6 & 1 & 10.7 & 0.999987 & 5.5 & 0.00006 &
...
3.35 & 4.37 & 0.233 & 11.92 & 2.93 & 13.8 & 1$^{\dagger}$ & 18.3 & 0.999986 & 13.7 & 0.00000 &
...
1.56 & 4.42 & 0.647 & 4.03 & 2.58 & 15.3 & 1$^{\dagger}$ & 8.3 & 0.999521 & 3.7 & 0.00066 &
...
4.54 & 5.87 & 0.227 & 27.16 & 2.73 & 14.3 & 1$^{\dagger}$ & 6.4 & 0.992018 & 2.3 & 0.00439 &
\notecell{Identified by \activityscope{}; activity observed in 2025 November} \\

\objectcell{2009~DP$_{2}$$^{\ast}$} &
3.82 & 6.65 & 0.425 & 26.77 & 2.61 & 14.2 & 1$^{\dagger}$ & 4.9 & 0.901645 & 0.9 & 0.01951 &
\notecell{Identified by \activityscope{}; recovered active in 2026} \\

\midrule
\newpage
\multicolumn{13}{l}{\textbf{Asteroidal orbits} \textnormal{\footnotesize (sorted by $P(N_{\rm opp}\ge4)$, descending)}}\\
\midrule

\objectcell{P/2023~JN$_{16}$ (Lemmon)$^{\ast}$} &
2.30 & 2.70 & 0.147 & 3.70 & 3.35 & 15.7 & 1$^{\dagger}$ & 19.7 & 0.999993 & 15.2 & 0.00000 &
...
2.37 & 2.48 & 0.048 & 7.24 & 3.46 & 15.4 & 1 & 21.0 & 0.999992 & 16.7 & 0.00000 &
...
2.94 & 3.07 & 0.042 & 11.51 & 3.20 & 15.2 & 1 & 20.7 & 0.999991 & 15.9 & 0.00000 &
...
2.57 & 2.72 & 0.057 & 5.01 & 3.35 & 17.5 & 1$^{\dagger}$ & 12.6 & 0.999989 & 7.9 & 0.00001 &
\notecell{Identified by \activityscope; Confirmed active in DECam and Pan-STARRS archives} \\

\objectcell{2009~FP$_{8}$} &
2.48 & 3.01 & 0.178 & 4.63 & 3.22 & 16.9 & 1 & 11.9 & 0.999987 & 6.8 & 0.00002 &
\notecell{Negative archival recovery, very high confidence candidate} \\

\objectcell{P/2017~FL$_{36}$ (PANSTARRS)$^{\ast}$} &
2.83 & 2.93 & 0.034 & 15.70 & 3.22 & 16.6 & 1 & 9.8 & 0.999985 & 5.0 & 0.00016 &
...
2.75 & 3.05 & 0.100 & 12.42 & 3.19 & 17.0 & 1 & 10.6 & 0.999978 & 5.8 & 0.00006 &
\notecell{Negative archival recovery, high confidence candidate} \\

\objectcell{2002~CW$_{116}$$^{\ast}$} &
2.07 & 2.69 & 0.231 & 8.14 & 3.32 & 17.5 & 1 & 9.3 & 0.999945 & 4.6 & 0.00025 &
